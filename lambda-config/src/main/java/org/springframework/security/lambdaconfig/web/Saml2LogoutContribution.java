...
final class Saml2LogoutContribution extends AbstractSecurityFilterChainContribution
	...
	@Override
	public LogoutRequestConfigurer request() {
		throw new UnsupportedOperationException();
	}

	@Override
	public void request(Consumer<LogoutRequestConfigurer> logoutRequest) {
		throw new UnsupportedOperationException();
	}

	@Override
	public void response(Consumer<LogoutResponseConfigurer> logoutResponse) {
		throw new UnsupportedOperationException();
	}

	@Override
	public LogoutResponseConfigurer response() {
		throw new UnsupportedOperationException();
	}
