...
public interface HttpSecurityFilterChain {
	...
	interface Configurer {
		...
		<C> void add(SecurityFilterChainContributor<C> contributor);

		<C> void add(SecurityFilterChainContributor<C> contributor, Consumer<C> cutomizer);

		<C> void remove(SecurityFilterChainContributor<C> contributor);
