...
/**
 * Tests for {@link IncludeExcludeInetAddressMatcher}.
 *
 * @author Rob Winch
 * @author pwebb
 */
class IncludeExcludeInetAddressMatcherTests {
	...
	void includingAddressesWhenMultipleAddressesThenMatchesAny(String testAddress) throws Exception {
	...
	void includingAddressesWhenCidrNotationThenMatchesSubnet(String testAddress) throws Exception {
	...
	void matchesWhenAddressInListThenReturnsTrue() throws Exception {
		...
		InetAddressMatcher matcher = InetAddressMatcher.of(addressString);
	...
	class InternalInetAddressMatcherTests {
		...
		void matchesWhenInetAddressNullThenReturnsFalse() {
			InetAddressMatcher matcher = InetAddressMatcher.ofInternalAddresses();
	...
	class ExternalInetAddressMatcherTests {
		...
		void matchesWhenIpv4PublicThenReturnsTrue(String address) throws Exception {
			InetAddressMatcher matcher = InetAddressMatcher.ofExternalAddresses();
			assertThat(matcher.matches(InetAddress.getByName(address))).isTrue();
		}
