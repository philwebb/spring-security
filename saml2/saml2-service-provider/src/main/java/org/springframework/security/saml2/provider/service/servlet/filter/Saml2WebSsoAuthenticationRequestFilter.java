...
public class Saml2WebSsoAuthenticationRequestFilter extends OncePerRequestFilter {
	...
	/**
	 * Use the given {@link Saml2AuthenticationRequestContextResolver} that creates a
	 * {@link Saml2AuthenticationRequestContext}
	 * @param authenticationRequestContextResolver the
	 * {@link Saml2AuthenticationRequestContextResolver} to use
	 * @since 5.4
	 */
	public void setAuthenticationRequestContextResolver(
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		RelyingPartyRegistration relyingParty = this.relyingPartyRegistrationRepository
